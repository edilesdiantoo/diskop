...
$route['translate_uri_dashes'] = FALSE;
$route['login']                = 'LoginDiskopController';
$route['input/(:any)']         = 'TransaksiController/input/$1';

//belajar baru
$route['menu/create']      = 'menu/create';
$route['menu/view/(:any)'] = 'menu/view/$1';

//api
// $route['api/login'] = 'Api/login';
$route['pengajuan-pelaku-usaha'] = 'Api/get_pelaku_usaha';
$route['tahun-pengajuan']        = 'Api/tahun';
...
$route['konfirmasi']             = 'PelatihanController/input4';
$route['bukti-pelatihan/(:any)'] = 'PelatihanController/bukti_pelatihan/$1';
$route['input-pelatihan']        = 'PelatihanController/landing';
