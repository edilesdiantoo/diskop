...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <!-- <button type="button" class="btn " data-toggle="modal"><span class="badge bg-primary">Primary</span></button> -->
        <!-- <button type="button" class="btn" data-toggle="modal"><span class="badge bg-primary">Primary</span></button> -->
    </div>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <!-- <div class="card-body">
                ...
                <span class="badge rounded-pill bg-secondary myspan" type="button" id="2024">2024</span>
            </div> -->
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                    ...
                    <?php } else {  ?>
                        <div class="col-6">
                            <div class="input-group mb-3">
                                <input type="text" id="search" class="form-control search" placeholder="" aria-label="search" aria-describedby="basic-addon1">
                                <!-- <span class="input-group-text" id="basic-addon1"><i class="bi bi-search"></i></span> -->
                                <!-- <button class="btn btn-outline-secondary" type="button" id="button-addon2"><i class=""></i>Nama</button> -->
                            </div>
                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $("span.myspan").click(function(e) {
            let tahun = $(this).attr("id");

            // $.ajax({
            //     type: "POST",
            //     url: "<?= base_url('VerifikasiController/') ?>",
            //     data: "data",
            //     dataType: "html",
    ...
    $(document).ready(function() {
        $('.level_satu').on('input', function() {
            ...
            $.ajax({
                url: '<?= site_url() ?>TransaksiController/searchPelakuUsahaLevelUser2024',
                type: 'POST',
                data: {
    ...
    $(document).ready(function() {
        $('#search').on('input', function() {
            ...
            // alert(search);
            $.ajax({
                url: '<?= site_url() ?>TransaksiController/searchPelakuUsaha2024',
                type: 'POST',
                data: {
                    nama_search: nama_search,
                },
