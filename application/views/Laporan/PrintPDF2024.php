<div class="row">
    <form id="upload_form" target="_blank" action="<?= base_url() ?>LaporanController/pdf2024" method="post" class="col-lg-12" enctype="multipart/form-data">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <select class="form-control mr-2" id="status" name="status" required>
                ...
                <?php
                // echo '<option value="3">Tidak menerima bantuan</option>';
                echo '<option value="0">Tidak layak</option>';
                // echo '<option value="1">Memenuhi Syarat</option>';
                // echo '<option value="0">Tidak Layak</option>';
                echo '<option value="1">Penerima</option>';
                ?>
                <!-- <?php if ($level != '3') {
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data Pelaku Usaha 2024</h4>
