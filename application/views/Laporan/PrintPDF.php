<div class="row">
    <form id="upload_form" target="_blank" action="<?= base_url() ?>LaporanController/pdf" method="post" class="col-lg-12" enctype="multipart/form-data">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <select class="form-control mr-2" id="status" name="status" required>
                ...
                echo '<option value="2">Penerima</option>';
                ?>
                <!-- <?php if ($level != '3') {
