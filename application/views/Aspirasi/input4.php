  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      if (id_kategori_dumisake == 1) {
        Swal.fire({
          ...
          // window.location.href = "<?= site_url() ?>AspirasiController/bukti_pengajauan/" + kk;
    ...
    $(document).ready(function() {
      $('#upload_form').on('submit', function(event) {
        ...
        $.ajax({
          url: "<?= site_url() ?>AspirasiController/simpanInputPelakuUsaha",
          method: "POST",
          ...
          success: function(data) {
            ...
            setTimeout(function() {
              ...
              Swal.fire({
                ...
                text: "UNTUK PRINT BUKTI PENGAJUAN SILAHKAN KUNJUNGI HALAMAN INPUT ASPIRASI",
                icon: "success",
                showClass: {
                  popup: 'animate__animated animate__fadeInDown'
                },
                ...
                // window.location.href = "<?= site_url() ?>AspirasiController/bukti_pengajauan/" + kk;
                window.location.href = "<?= site_url() ?>AspirasiController/aspirasi/";
              });
            }, 3000);
