...
<div class="row">
    <form id="upload_form" target="_blank" action="<?= base_url() ?>LaporanController/pdfRekomendasi2024" method="post" class="col-lg-12" enctype="multipart/form-data">
        <!-- <form id="" action="<?= base_url() ?>LaporanController/PrintPenerima" class="col-lg-12" method="post" enctype="multipart/form-data"> -->
        <div class="col-lg-12 grid-margin stretch-card">
            <select class="form-control  mr-3 getTahunPenerima" id="tahun_penerima" name="tahun" required>
