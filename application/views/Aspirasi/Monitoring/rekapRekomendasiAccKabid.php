                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="" class="table">
                                ...
                                <tbody id="">
                                    <?php $no = 1;
                                    foreach ($TotalCalonPenerimaAspirasi as $key) { ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                    ...
                                    <tr>
                                        <th colspan="8" style="text-align: right; background-color: #DCDCDC;">Total Aspirasi :</th>
                                        <th colspan="3" style="text-align: left; background-color: #DCDCDC;" id="totCalonPenrima"></th>
                                    </tr>
