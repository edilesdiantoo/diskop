...
<body class="bg-image">
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col">
                <div class="fs-4 fw-bold text-white text-center">PEMERINTAH PROVINSI JAMBI PROGRAM GUBERNUR JAMBI DUMISAKE TAHUN 2023</div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <div class="row justify-content-center pt-3">
                <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                    <input class="form-control iawal" id="no_kk" accept="number" name="no_kk" type="text" placeholder="">
                </div>
            </div>
            <div class="text-center pt-3">
                <a href="<?= base_url() ?>AspirasiController/Panduan" class="text-white"><i class="bi bi-box-arrow-up-left"></i>
...
<script>
    ...
    $(document).ready(function() {
        $('#no_kk').on('change', function(even) {
            ...
            $.ajax({
                url: '<?= site_url() ?>AspirasiController/cekNoKK/' + no_kk,
                type: 'POST',
                dataType: 'JSON',
                success: function(data) {
                    if (data.cekNoKK != null) {
                        $('#myModal').modal('show');
                        // $("#no_kk")[0].reset();
                        // no_kk.reset(); // Reset all form data
                        // this.reset();
                    } else {
                        // window.location.href = "<?= site_url() ?>AspirasiController/landing";
                        window.location.href = "<?= site_url() ?>AspirasiController/input";
                    }
                }
            })
    ...
    $(document).ready(function() {
        $('#bukti_pengajuan').on('click', function(even) {
            // alert("kkd");
            const no_kk = $("#no_kk").val();
            window.location.href = "<?= site_url() ?>AspirasiController/bukti_pengajauan/" + no_kk;
        });
    });
