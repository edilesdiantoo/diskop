...
<body class="bg-color">
  ...
  <div class="container">
    <form class="" id="upload_form" method="post" enctype="multipart/form-data" action="<?= site_url() ?>AspirasiController/input3">
      <div class="row pt-4">
        <div class="col">
          <div class="mb-3">
            <input type="text" class="form-control" placeholder="Alamat sesuai KTP" name="alamat" required>
          </div>
          <div class="mb-3">
  ...
  <script type="text/javascript">
    ...
    $('#prov').change(function() {
      ...
      // alert(prov);
      $.ajax({
        url: '<?= site_url() ?>AspirasiController/getKab/' + prov,
        type: 'POST',
    ...
    $('#kab').change(function() {
      ...
      // alert(kab);
      $.ajax({
        url: '<?= site_url() ?>AspirasiController/getKec/' + kab,
        type: 'POST',
        success: function(data) {
          // console.log(data);
          $('#kec').html(data);
    ...
    $('#kec').change(function() {
      ...
      // alert(kab);
      $.ajax({
        url: '<?= site_url() ?>AspirasiController/getKel/' + kec,
        type: 'POST',
        success: function(data) {
          // console.log(data);
          $('#kel').html(data);
