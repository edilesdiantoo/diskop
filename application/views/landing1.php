...
<body class="bg-image">
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col">
                <div class="fs-4 fw-bold text-white text-center">PEMERINTAH PROVINSI JAMBI PROGRAM GUBERNUR JAMBI PRO TAHUN 2026</div>
            </div>
        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.cekNoKK != null) {
                                ...
                                // window.location.href = "<?= site_url() ?>input/" + CryptoJS.MD5(no_kk);
                                window.location.href = "<?= site_url() ?>input/" + no_kk;
                            }
                        }
                    })
